      ...
      <div class="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
        ...
        <div class="lg:hidden">
          <div class="w-full mb-6 lg:mb-0 mx-auto relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0">
            <!-- profile image  -->
            <img src="https://i.pravatar.cc/450" class="w-[240px] absolute left-[50%] transform -translate-x-[50%] h-[240px] drop-shadow-xl mx-auto rounded-[20px] -mt-[140px]" alt="about" />
          ...
          <div class="col-span-12 space-y-2.5">
            <div class="lg:mr-16">
              <p class="text-[#44566c] dark:text-white leading-7">
                Hello , I'm Mohsen Sami, a software engineer who lives in Tehran (Iran).
                <br />- I am Always trying to study both the front-end and back-end sides to have a good understanding of the web. <br />- I am always keep on taking up something challenging almost every day. <br />- Experienced in Vue.js, Python, Django, and recently JavaScript (Vuejs). <br />- I am currently focused on making web applications and user interfaces with Vue.
              </p>
              <p class="text-[#44566c] leading-7 mt-2.5 dark:text-white">
                Skills:
                <br />• Languages: JavaScript, PHP, Python <br />• Frontend: Vue, HTML, CSS, SASS, CSS-in-JS <br />• UI frameworks and libraries: JQuery, VueJs, RestApi, Bootstrap, AntDesign, MaterialUI <br />• Backend: Python, Django, some experiences with FastApi and Laravel <br />• Databases: MySQL, PostgreSQL <br />• Familiar with CI/CD mechanism and tools like Gitlab <br />• Familiar with TDD, Unit testing, CQRS, Event Sourcing, Microservices, ... <br />• Familiar with Rabbit, Redis, Docker,...
              </p>
            </div>
            <div></div>
          </div>
