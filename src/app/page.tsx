...
import { getCategoriesWithPostsCached, getLatestPostsCached, getPopularPostsCached } from '@/lib/posts';
...
export default async function HomePage() {
    const [popularPosts, latestPosts, categoriesWithPosts, latestComments, session] = await Promise.all([
        ...
        <main className="container px-4 py-8">
            <section className="relative mb-12 overflow-hidden rounded-3xl bg-gradient-to-bl from-emerald-600 via-teal-600 to-cyan-700 px-6 py-12 text-white shadow-xl sm:px-10 sm:py-14">
                ...
                <div className="relative">
                    ...
                    <h1 className="mb-4 text-3xl font-bold leading-12 sm:text-4xl">دنیای برنامه‌نویسی</h1>
                    <p className="mb-8 max-w-2xl text-base leading-8 text-emerald-50/90">
                        آخرین مقالات، آموزش‌ها و نکات برنامه‌نویسی — از ری‌اکت و جاوااسکریپت تا معماری نرم‌افزار و هوش
                        مصنوعی.
                    </p>
