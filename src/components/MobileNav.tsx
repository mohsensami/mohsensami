    ...
    return (
        <Sheet>
            <SheetTrigger asChild>
                <Button variant="outline" size="icon" className="md:hidden" aria-label="باز کردن منو">
            ...
            <SheetContent side="right" className="w-[min(100vw-2rem,320px)]">
                ...
                <nav className="px-8 mt-6 flex flex-col gap-1">
                    {links.map((link) => (
                        <Link
                            key={link.href}
                            href={link.href}
                    ...
                    <div className="mt-6 flex justify-center items-center gap-4 border-t border-stone-200 pt-4 dark:border-stone-800 dark:text-white">
