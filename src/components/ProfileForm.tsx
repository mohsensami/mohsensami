    ...
    return (
        <div className="space-y-8">
            <section className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm dark:border-stone-800 dark:bg-stone-900">
                <h2 className="mb-4 text-lg font-bold text-stone-900 dark:text-stone-100">پروفایل</h2>

                <form action={profileAction} className="space-y-5">
                    <div className="flex items-center gap-4">
                        <UserAvatar user={{ name: user.name, email: user.email, image: avatarUrl || null }} size="lg" />
                    ...
                    <ImageUploadField
                        ...
                        label="آپلود آواتار"
                        uploadType="profile"
                        onChange={(image) => setAvatarUrl(image.url)}
                    />
            ...
            {user.hasPassword && (
                <section className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm dark:border-stone-800 dark:bg-stone-900">
                    <h2 className="mb-4 text-lg font-bold text-stone-900 dark:text-stone-100">تغییر رمز عبور</h2>
