            ...
            <div className="menu-content">
              ...
              <div className="knowledge">
                <div className="knowledge-container">
                  ...
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>Context
                      API
                    </span>
                  </div>
                  <div className="knowledge-content">
                  ...
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>Material
                      UI
                    </span>
                  </div>
                  <div className="knowledge-content">
                  ...
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>MySQL,
                      postgresql
                    </span>
                  </div>
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>Django
                      and FastApi
                    </span>
                  </div>
                  <div className="knowledge-content">
                  ...
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>Postgre
                      / Redis
                    </span>
                  </div>
                  <div className="knowledge-content">
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>Celery -
                      rabbitMq
                    </span>
                  </div>
                  <div className="knowledge-content">
              ...
              <div className="social">
                <div className="social-container">
                  <ul>
                    <li>
                      <a
                        href="https://www.linkedin.com/in/mohsensami"
                        target="_blank"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.github.com/mohsensami/"
                        target="_blank"
                      >
                    ...
                    <li>
                      <a
                        href="https://www.instagram.com/_mohsensami"
                        target="_blank"
                      >
                    ...
                    <li>
                      <a href="https://t.me/mohsensami88" target="_blank">
