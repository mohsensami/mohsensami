        ...
        const { openFilePicker } = useFilePicker({
            ...
            onFilesSelected: (data: SelectedFilesOrErrors<undefined>) => {
                ...
                if (restFiles.length > 0) {
                    editor.getTransforms(PlaceholderPlugin).insert.media(fileArrayToFileList(restFiles));
                }
            },
        });
...
export function ImageProgress({
    ...
    return (
        <div className={cn('relative', className)} contentEditable={false}>
            {/* eslint-disable-next-line @next/next/no-img-element -- Plate upload preview blob URL */}
