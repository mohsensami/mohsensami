                                  ...
                                  <div
                                      ...
                                      <div class="pt-[100px] pb-8">
                                          ...
                                          <button class="dowanload-btn">
                                              <img class="mr-3" src="../../public/img/dowanload.png" alt="icon" /> Download
                                              CV
                                          </button>
                                      </div>
                                  </div>
                          ...
                          <div class="pb-12 px-2 sm:px-5 md:px-10 lg:px-14">
                              ...
                              <div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
                                  <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                                  ...
                                  <div class="about-box bg-[#fefaf0] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon1.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                                  ...
                                  <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon2.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                                  ...
                                  <div class="about-box bg-[#fff4f4] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon3.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                                          <h3 class="dark:text-white text-[22px] font-semibold"> Photography </h3>
                                          <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]"> Lorem ipsum dolor sit
                                  ...
                                  <div class="about-box bg-[#fff0f8] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon4.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                                  ...
                                  <div class="about-box bg-[#f3faff] dark:bg-transparent">
                                      <img class="w-10 h-10 object-contain block" src="../../public/img/icon5.svg"
                                          alt="icon" />
                                      <div class="space-y-2">
                          ...
                          <footer class="overflow-hidden rounded-b-2xl" style="background: transparent">
                              <p class="text-center py-6 text-gray-lite dark:text-color-910"> © 2022 All Rights Reserved
                                  by <a class="hover:text-[#FA5252] duration-300 transition"
                                      href="/" target="_blank"
                                      rel="noopener noreferrer"> mohsensami</a>. </p>
                          </footer>
                          <!-- footer section end -->
                      </div>
                  </div>
